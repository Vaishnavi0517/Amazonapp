...
import com.example.amazonapp.MenuFiles.ProfileActivity;
...
public class ShowHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        orderList.setLayoutManager(new LinearLayoutManager(ShowHistoryActivity.this));
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Orders> options = new FirebaseRecyclerOptions.Builder<Orders>()
                .setQuery(orderRef.child("Orders").child(auth.getCurrentUser().getUid())
        ...
        FirebaseRecyclerAdapter<Orders, OrdersViewHolder> adapter =
                new FirebaseRecyclerAdapter<Orders, OrdersViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull OrdersViewHolder holder, int position, @NonNull Orders model) {
                        ...
                        holder.orderDate.setText(model.getCity());
